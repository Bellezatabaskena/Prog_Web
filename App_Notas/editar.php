            ...
            <div class="row justify-content-center align-item-center h-100">
                <div class="col-12 col-sm-12 col-md-12 mb-12">
                    <div class="card">
                        ...
                        $fila = mysqli_fetch_assoc($ejecutar);
                        ?>
                            <form action="./function/update.php?id=<?php echo $fila['id_notas'];?>" method="post">
                                <div class="mb-3 card text-bg-info">
                                    <label class="card-header" style ="text-align:center; font-weight: bold;">Editar Nota</label>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Editar de Nota</label>
                                    <input name="nota" type="text" class="form-control bg-info" value="<?php echo $fila['nota'];?>">
                                </div>
