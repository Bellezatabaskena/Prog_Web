                        ...
                        ?>
                            <form action="../function/update.php?id=<?php echo $fila['id_nivel'];?>" method="post">
                                <div class="mb-3 card text-bg-info">
                                    <label class="card-header" style ="text-align:center; font-weight: bold;">Editar Nivel</label>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Tipo de Area</label>
                                    <input name="nombre" type="text" class="form-control bg-info" value="<?php echo $fila['nombre_nivel'];?>">
                                </div>
