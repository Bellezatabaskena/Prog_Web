                  ...
                  <tbody>
                      ...
                      ?>
                       <tr>
                                            ...
                                            <td scope="row"><a href="./View/editar.php?id=<?php echo $fila['id_area'];?>"class="btn btn-warning">Editar</a></td>
                                            <td scope="row"><a href="./function/delete.php?id=<?php echo $fila['id_area'];?>"class="btn btn-danger">Eliminar</a></td>
                                        </tr>
                    <?php
                  $contador++; }?>
                  </tbody>
